...
class VGGSound_dataset(object):
    def __init__(self, path_to_dataset = '/data1/zhangxiaohui/k400/kinsound/visual/', frame_interval=1, frame_kept_per_second=1, mode="train"):
        self.path_to_video = os.path.join(path_to_dataset, mode)
        self.frame_kept_per_second = frame_kept_per_second
        self.path_to_save = os.path.join(path_to_dataset, '{}_unsplit_imgs'.format(mode), 'Image-{:02d}-FPS'.format(self.frame_kept_per_second))
